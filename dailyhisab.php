...
<header>
    ...
    <div class="row mt-2">
        <div class="col-12 h3 d-flex justify-content-center"><button <?php echo 'endate="'.$_REQUEST["date"].'" bddate="'.$_REQUEST["bddate"].'" Weekday="'.$_REQUEST["Weekday"].'"'?> class="btn btn-info" id="print">প্রিন্ট করুন</button></div>
    </div>
    ...
    <div class="row rowmapping">
        ...
        <div class="col-12 d-flex justify-content-center">
            <p><h6>বাংলাঃ <span id="bangladate"></span></h6></p>
        </div>
        <div class="col-12 d-flex justify-content-center">
            <p><h6>ইংঃ <span id="engdate"><?php echo Dateconverter::en2bn(date("d F,Y"));?> সাল</span></h6></p>
        </div>
        <div class="col-12 d-flex justify-content-center">
            <p><h6>রোজঃ <span id="engbar">রবিবার</span></h6></p>
        </div>
    </div>
    <div class="row mt-3">
...
<script>
    $(document).ready(function(){
        $("#bangladate").html(new buetDateConverter().convert("j F, Y সন"))
        $("#engbar").html(new buetDateConverter().convert("l"))
    })
    $(document).on("click","button#print",function(){
        var endate=$(this).attr("endate");
        var bddate=$(this).attr("bddate");
        var Weekday=$(this).attr("Weekday");
       Notiflix.Loading.hourglass('প্রসেসিং...');
            $.post("hisaboperation.city",{func:'complite',date:endate,bddate:bddate,Weekday:Weekday}).done(function(data){
                alert(data);
                if(data==1){
                    setTimeout(() => {

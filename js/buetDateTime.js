...
function buetDateConverter(inputDate)
{
	...
	this.firstDayInBD = this.formatConvertList.multiplierEN[0]+this.formatConvertList.multiplierEN[1]+this.formatConvertList.multiplierEN[2]+15;
...
buetDateConverter.prototype.formatConvertList = 
{
	...
	"multiplierBD" : [31,31,32,31,31,31,30,29,29,30,30,30],
